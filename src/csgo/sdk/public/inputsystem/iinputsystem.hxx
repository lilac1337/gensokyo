...
public:
	...
	virtual Vector4<float> GetMotionControllerOrientation() const = 0; // Pointer direction
	...
	virtual u64		   GetMotionControllerDeviceStatusFlags() const = 0;
	...
	virtual void GetStandardCursor(InputStandardCursor_t id) = 0;
