...
public:
	...
	public:
		...
		inline void		SetFirst(void) __restrict;
		inline void		Next(void) __restrict;
		inline bool		IsValid(void) __restrict;
		inline ConCommandBase* Get(void) __restrict;
	private:
...
protected:
	...
	public:
		...
		virtual void		SetFirst(void) __restrict = 0;
		virtual void		Next(void) __restrict = 0;
		virtual	bool		IsValid(void) __restrict = 0;
		virtual ConCommandBase* Get(void) __restrict = 0;
	};
...
inline void ICvar::Iterator::SetFirst(void) __restrict
{
	m_pIter->SetFirst();
}

inline void ICvar::Iterator::Next(void) __restrict
{
	m_pIter->Next();
}

inline bool ICvar::Iterator::IsValid(void) __restrict
{
	return m_pIter->IsValid();
}

inline ConCommandBase* ICvar::Iterator::Get(void) __restrict
{
	return m_pIter->Get();
}
