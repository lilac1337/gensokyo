...
[[nodiscard]] static uintptr_t gensokyo::util::findBytes(const uintptr_t& start_address, const uintptr_t& end_address, const char* target_pattern) noexcept {
...
[[nodiscard]] static uintptr_t gensokyo::util::findPattern(const char* module, const char* target_pattern) noexcept {
	...
	return findBytes(start_address, end_address, target_pattern);
}
